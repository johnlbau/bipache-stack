...
##   $ docker build -t tomcat-for-johnlbau-bipache-stack .
##
## RUNNING
##   $ docker run -p 8080:8080 tomcat-for-johnlbau-bipache-stack
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="r7pfvkf" \
    STACKSMITH_STACK_NAME="Tomcat for johnlbau/bipache-stack" \
